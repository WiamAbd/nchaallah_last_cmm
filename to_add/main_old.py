...
def build_prompt(
    ...
    prompt = (
        ...
        '- If no function is matching at all select "null" as a function name with no parameter\n\n'
...
def generate(
    ...
    try:
        ...
        print(f"No function matches prompt: {request}")
        sys.exit(1)
...
def main() -> None:
    ...
    try:
        ...
        for item in prompts:
            ...
            output = generate(model, full_prompt, prompt_text)            
